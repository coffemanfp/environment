# Generated by Powerlevel10k configuration wizard on 2022-04-07 at 23:04 -05.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && auxRes+=" ${conflicted}~${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && auxRes2+=" ${modified}+${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && auxRes+=" ${modified}!${VCS_STATUS_NUM_UNSTAGED}"
    # ?42 if have untracked files. It's really a question mark, your font isn't broken.
    # See POWERLEVEL9K_VCS_UNTRACKED_ICON above if you want to use a different icon.
    # Remove the next line if you don't want to see untracked files at all.
    (( VCS_STATUS_NUM_UNTRACKED  )) && auxRes+=" ${untracked}${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
	[ ! -z "$auxRes" ] && res+=" ${conflicted}✘"
	[ ! -z "$auxRes2" ] && res+=" ${clean}✚"
